...
import DonationSuccessTracker from "@/features/donations/DonationSuccessTracker";
import TrustStrip from "@/features/donations/TrustStrip";
  ...
  return [
    {
      ...
      label: l(
        ...
        "garder les listes de démarches gratuites pour tous",
        "die Checklisten für alle kostenlos halten",
        "d'Checklëschte fir jiddereen gratis halen"
      ),
    },
    {
      icon: "\u{1F5A5}\uFE0F",
      label: l(
        ...
        "expliquer les démarches administratives complexes dans un langage simple",
        "schwierige administrative Aufgaben in verständlicher Sprache erklären",
        "schwiereg administrativ Démarchen an einfacher Sprooch erklären"
      ),
    },
    {
      icon: "\u{1F30D}",
      label: l(
        ...
        "traduire les conseils dans plus de langues",
        "die Orientierungshilfen in weitere Sprachen übersetzen",
        "d'Orientéierung an nach méi Sproochen iwwersetzen"
      ),
    },
    {
      icon: "\u267F",
      label: l(
        ...
        "rendre les ressources plus faciles à lire et à utiliser",
        "die Materialien einfacher zu lesen und zu nutzen machen",
        "d'Ressourcen méi einfach liesbar a benotzbar maachen"
      ),
    },
    {
      icon: "\u2713",
      label: l(
        ...
        "maintenir les informations vérifiées et à jour",
        "die Informationen geprüft und auf dem neuesten Stand halten",
        "d'Informatiounen iwwerpréift an aktuell halen"
      ),
    },
    {
      icon: "\u{1F91D}",
      label: l(
        ...
        "aider plus de familles à trouver du soutien au moment où elles en ont besoin",
        "mehr Familien helfen, Unterstützung zu finden, wenn sie sie brauchen",
        "méi Familljen hëllefen, Ënnerstëtzung ze fannen, wann se se brauchen"
      ),
    },
  ];
}
            ...
            <div className="space-y-4">
              ...
              >
                {l(
                  ...
                  "Support Clarvia",
                  "Soutenir Clarvia",
                  "Clarvia unterstützen",
                  "Clarvia ënnerstëtzen"
                )}
              </h1>
              <p className="text-lg text-calm-blue-600 leading-relaxed font-semibold">
                {l(
                  ...
                  "Wann een nooste Mënsch stierft, gi Familljen dacks erwaart, sech ëm Pabeieren, Institutiounen, Fristen a grenziwwerschreidend Froen ze këmmeren, wärend si nach an der Trauer sinn."
                )}
              </p>
              ...
              <div className="grid grid-cols-2 gap-3">
                {getFundItems(lang).map((item) => (
                  ...
                  >
                    ...
                    <p className="text-xs font-semibold text-calm-blue-700">{item.label}</p>
                  </div>
                ))}
              </div>
            </div>
