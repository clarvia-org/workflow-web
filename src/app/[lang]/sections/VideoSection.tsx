        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 flex flex-col justify-center">
            <h2 className="text-2xl sm:text-3xl font-semibold mb-4 text-left" style={headlineStyle}>
              {l(lang, "Follow Our Journey", "Suivez notre parcours", "Folgen Sie unserer Reise", "Eise Wee verfollegen")}
            </h2>
            <p className="text-base text-calm-blue-600 leading-relaxed mb-6">
              {l(lang, "No one should have to figure out the practical side of loss alone. We are building a free, practical service to support families when it matters most, and we are learning from families, caregivers, and professionals along the way. Follow our updates and watch our progress on YouTube.", "Personne ne devrait avoir à affronter seul les aspects pratiques d'un décès. Nous construisons un service gratuit et pratique pour accompagner les familles au moment où elles en ont le plus besoin, en apprenant chaque jour des familles, des soignants et des professionnels. Suivez nos actualités et notre progression sur YouTube.", "Niemand sollte die praktischen Aspekte eines Verlusts allein bewältigen müssen. Wir bauen ein kostenloses, praktisches Angebot auf, um Familien zu unterstützen, wenn es am wichtigsten ist, und lernen dabei ständig von Familien, Pflegenden und Fachkräften. Verfolgen Sie unsere Updates und unseren Fortschritt auf YouTube.", "Keen soll déi praktesch Säit vun engem Verloscht eleng misse verstoen. Mir bauen e gratis, praktesche Service op, fir Familljen z'ënnerstëtzen, wann et am wichtegsten ass, a mir léiere dobäi vu Familljen, Fleegenden a Fachleit. Follegt eisen Neiegkeeten a kuckt eise Fortschrëtt op YouTube.")}
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              >
                <span>📺</span>
                {l(lang, "Watch Playlist on YouTube", "Voir la playlist sur YouTube", "Playlist auf YouTube ansehen", "Playlist op YouTube kucken")}
              </a>
            </div>
          </div>
            ...
            <div className="relative w-full max-w-[280px] aspect-[9/16] rounded-2xl overflow-hidden shadow-xl border border-white/50 bg-slate-900">
              {isPlaying ? (
                ...
                <button
                  ...
                  aria-label={l(lang, "Play video update", "Lire la vidéo d'actualité", "Video-Update abspielen", "Video-Update ofspillen")}
                >
                  {/* Play Button Icon */}
                  ...
                  <span className="mt-4 text-xs font-semibold uppercase tracking-wider text-white/80 group-hover:text-white transition-colors">
                    {l(lang, "Play Update", "Lire l'actualité", "Update abspielen", "Update ofspillen")}
                  </span>
                </button>
              )}
            </div>
