    ...
    <>
      ...
      <section id="experience" className="mb-20 scroll-mt-24">
        <h2 className="text-2xl sm:text-3xl font-semibold text-center mb-4" style={headlineStyle}>
          {l(lang, "Share your experience", "Partager votre expérience", "Teilen Sie Ihre Erfahrung")}
        </h2>
        <p className="text-base text-calm-blue-600 text-center max-w-2xl mx-auto mb-3 leading-relaxed">
          {l(lang,
            ...
            "Si vous avez dû gérer des démarches pratiques après la perte d'un proche au Luxembourg, votre expérience peut nous aider à concevoir un meilleur service.",
        ...
        <p className="text-sm text-calm-blue-500 text-center max-w-2xl mx-auto mb-8 leading-relaxed">
          {l(lang,
            ...
            "Vous n'avez pas besoin de partager des informations privées. Nous nous intéressons surtout aux obstacles pratiques : qu'est-ce qui a été le plus difficile à comprendre ? Quels documents ont été compliqués à trouver ? Quelles institutions ou démarches n'étaient pas claires ? Qu'est-ce qui vous aurait le plus aidé ? Dans quelle langue le processus aurait-il été plus simple ?",
        ...
        <div className="glass-panel p-6 sm:p-8 max-w-2xl mx-auto">
          {feedbackForm.status === "sent" ? (
            <div className="text-center py-8">
              ...
              <p className="text-lg font-medium" style={{ color: "#2b3a67" }}>
                {l(lang, "Thank you for sharing", "Merci pour votre partage", "Vielen Dank fürs Teilen")}
              </p>
              <p className="text-base text-calm-blue-500 mt-1">
                {l(lang, "Your experience will help us build a better service.", "Votre expérience nous aidera à construire un meilleur service.", "Ihre Erfahrung hilft uns, einen besseren Dienst aufzubauen.")}
              </p>
            </div>
          ) : (
            <form
          ...
          <p className="text-xs text-calm-blue-400 text-center mt-4 leading-relaxed">
            {l(lang,
              ...
              "Merci de ne pas envoyer de numéros d'identification, de dossiers médicaux, de coordonnées bancaires, d'informations juridiques confidentielles ou de documents privés via ce formulaire.",
      ...
      <section id="contact" className="mb-10 scroll-mt-24">
        <h2 className="text-2xl sm:text-3xl font-semibold text-center mb-4" style={headlineStyle}>
          {l(lang, "Work with us", "Travailler avec nous", "Mit uns zusammenarbeiten")}
        </h2>
        <p className="text-base text-calm-blue-600 text-center max-w-2xl mx-auto mb-3 leading-relaxed">
          {l(lang,
            "Clarvia is currently in its build and validation phase. We welcome contact from:",
            "Clarvia est actuellement en phase de construction et de validation. Nous sommes ouverts aux échanges avec :",
          ...
          {contactForm.status === "sent" ? (
            <div className="text-center py-4">
              ...
              <p className="text-base font-medium text-calm-lilac-600">
                {l(lang, "Message sent - we will be in touch!", "Message envoyé - nous vous recontacterons !", "Nachricht gesendet - wir melden uns!")}
              </p>
            </div>
          ) : (
            <form
            ...
            >
              ...
              <button type="submit" disabled={contactForm.status === "sending"}
                ...
                {contactForm.status === "sending" ? l(lang, "Sending...", "Envoi...", "Senden...") : l(lang, "Send message", "Envoyer le message", "Nachricht senden")}
              </button>
            </form>
          )}
