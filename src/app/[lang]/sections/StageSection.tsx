      ...
      <section className="mb-20">
        <h2 className="text-2xl sm:text-3xl font-semibold text-center mb-10" style={headlineStyle}>
          {l(lang,
            ...
            "Une association récemment fondée, un projet soigneusement préparé",
        ...
        <div className="glass-panel p-8 sm:p-10 max-w-2xl mx-auto">
          <p className="text-base text-calm-blue-600 leading-relaxed mb-2">
            {l(lang,
              ...
              "Clarvia ASBL a été fondée au Luxembourg en mai 2026.",
          ...
          <p className="text-base text-calm-blue-600 leading-relaxed mb-6">
            {l(lang,
              ...
              "L'association est nouvelle, mais le projet a été préparé avec soin. Durant cette période, les fondateurs ont travaillé sur :",
          ...
          <p className="text-base text-calm-blue-700 font-medium leading-relaxed pt-4 border-t border-calm-blue-100">
            {l(lang,
              ...
              "La prochaine étape est une phase ciblée de développement et de validation.",
      ...
      <section className="mb-20">
        <h2 className="text-2xl sm:text-3xl font-semibold text-center mb-10" style={headlineStyle}>
          {l(lang,
            ...
            "Six mois pour développer, valider et préparer le service",
        ...
        <div className="glass-panel p-8 sm:p-10 max-w-2xl mx-auto">
          <p className="text-base text-calm-blue-600 leading-relaxed mb-6">
            {l(lang,
              ...
              "La prochaine phase de Clarvia devrait durer environ six mois. Durant cette période, nous souhaitons :",
          ...
          <p className="text-sm text-calm-blue-500 leading-relaxed pt-4 border-t border-calm-blue-100">
            {l(lang,
              ...
              "Ce travail nécessite une capacité dédiée, que ce soit par l'intermédiaire d'un salarié, d'un prestataire spécialisé ou d'une combinaison des deux.",
